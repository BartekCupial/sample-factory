...
for atari_game in atari_games:
    for learning_rate in [1e-5, 5*1e-5, 1e-4, 5*1e-4, 1e-3]:
        params_grid += [
            {
                "seed": list(range(3)),
                ...
                "unfreeze": [
                    {
                        "actor_encoder": 5_000_000,
                        "actor_core": 5_000_000,
                        "actor_decoder": 5_000_000,
                        "action_parameterization": 5_000_000,
                    }
                ],
            },
        ]

...
for atari_game in atari_games:
    for learning_rate in [5*1e-6, 1e-5, 5*1e-5]:
        params_grid += [
            {
                "seed": list(range(3)),
                ...
                "critic_learning_rate": [learning_rate * 5, learning_rate * 10, learning_rate * 15],
                "remove_critic": [False],
                "freeze": [{"actor_encoder": 0, "actor_core": 0, "actor_decoder": 0, "action_parameterization": 0}],
                "unfreeze": [
                    {
                        "actor_encoder": 20_000_000,
                        "actor_core": 20_000_000,
                        "actor_decoder": 20_000_000,
                        "action_parameterization": 20_000_000,
                    }
                ],
            },
        ]

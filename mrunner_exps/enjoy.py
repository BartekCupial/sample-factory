...
# params for all exps
config = {
    "run_script": "sf_examples.nethack.enjoy_nethack",
    "env": "challenge",
    "exp_tags": [name],
...
csv_folder_name = f"{config['character']}_episodes{config['max_num_episodes']}"
train_dir = "train_dir"
experiment = "amzn-AA-BC_pretrained"
...
params_grid = [
    {
        ...
        "teacher_path": ["/home/bartek/train_dir/APPO-KS-best"],
        "kickstarting_loss_coeff": [0],
    },
]

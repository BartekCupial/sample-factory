...
for rollout in [128]:
    for target_batch_size in [128]:
        ...
        for actor_learning_rate in [None, 0.00005, 0.00001, 0.000005, 0.000001]:
            params_grid.append(
                {
                    "seed": list(range(3)),
                    "learning_rate": [0.0001],
                    ...
                    "critic_add_layernorm": [True, False],
                    "critic_replace_bn_with_ln": [True],
                }
            )
            if actor_learning_rate is not None:
                params_grid[-1]["learning_rate_groups"] = [
                    {
        ...
        for actor_learning_rate in [None, 0.00005, 0.00001, 0.000005, 0.000001]:
            ...
            if actor_learning_rate is not None:
                params_grid[-1]["learning_rate_groups"] = [
                    {
                        "encoder": actor_learning_rate,
                        "core": actor_learning_rate,
                        "decoder": actor_learning_rate,

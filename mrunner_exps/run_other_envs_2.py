...
config = {
    ...
    "wandb_project": "atari",
    "wandb_group": "Check sticky actions",
    "wandb_tags": [name],
    "with_wandb": True,
}
...
atari_games = ["phoenix", "namethisgame", "choppercommand", "mspacman", "upndown", "beam_rider"]
    ...
    params_grid += [
        {
            ...
            "delta": [0.99],
            "dr_threshold": [1.0],  # disabled
            "l2_init_loss_coeff": [0.0],  # disabled
        },
    ]

...
config = {
    ...
    "num_workers": 2,
    "num_envs_per_worker": 4,  # 8*16=128 - like in the paper
    "worker_num_splits": 2,
    ...
    "wandb_group": "heatmaps + S&P on PPO",
    "wandb_tags": [name],
...
params_grid = [
    {
        ...
        "freq_shrink_perturb": [5_000_000],
        "shrink": [0.4],
        "perturb": [0.1],
        "modules_to_perturb": [
            ["encoder", "decoder", "extra_layer_actor", "action_parameterization", "extra_layer_critic", "critic"],
            ["predictor_network"],
            ["encoder", "decoder", "extra_layer_actor", "action_parameterization"],
            ["encoder", "decoder", "extra_layer_critic", "critic"],
        ],
        "l2_init_loss_coeff": [0.0],
        "log_heatmaps_to_wandb": [False],

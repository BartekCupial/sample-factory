...
def add_extra_params_general(parser):
    ...
    p.add_argument("--modules_lora", type=ast.literal_eval, default={})
    p.add_argument("--r_lora", type=int, default=16)
    p.add_argument("--modules_unfreeze", type=ast.literal_eval, default={})

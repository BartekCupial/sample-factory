...
def add_extra_params_general(parser):
    ...
    p.add_argument("--sil_loss_coeff", type=float, default=0.0)
    p.add_argument("--sil_beta_coeff", type=float, default=0.0)
    p.add_argument("--sil_clip_coeff", type=float, default=1.0)

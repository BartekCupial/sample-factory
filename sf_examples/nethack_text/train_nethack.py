...
from sf_examples.nethack_text.models import MODELS_LOOKUP
from sf_examples.nethack_text.nethack_env import NETHACK_ENVS, make_nethack_env
from sf_examples.nethack_text.nethack_params import (
...
def make_nethack_model(cfg: Config, obs_space: ObsSpace, action_space: ActionSpace):
    ...
    return model_cls(cfg, obs_space, action_space)


def register_nethack_components():
    register_nethack_envs()
    global_model_factory().make_actor_critic_func = make_nethack_model
